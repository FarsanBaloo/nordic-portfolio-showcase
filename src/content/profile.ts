...
export const journeyNarrative = {
  ...
  paragraphs: [
    ...
    "Working with Product Owners and R&D, I turned recurring field issues into structured product feedback and enhancement proposals, prioritised critical defects and validated releases. As Senior Technical Advisor, I led customer and technical discovery for complex healthcare, pharmaceutical and other mission-critical environments — developing and presenting solution proposals, weighing trade-offs against customer value, feasibility, lifecycle risk and cost, and holding end-to-end technical responsibility from problem definition through delivery.",
