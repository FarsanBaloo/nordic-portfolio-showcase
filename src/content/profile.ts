...
export const journeyNarrative = {
  ...
  paragraphs: [
    ...
    "After completing my postgraduate studies, in October 2026 I stepped into the Nordic Technical Support Expert role for Building Management Systems — supporting technicians, EcoXpert partners and Level 2 advanced support engineers across the Nordic region, owning major strategic customers, and prioritising Nordic defects and improvements with R&D for EcoStruxure Building Operation and its edge controllers. The role brings regional customer insight closer to platform-quality and lifecycle decisions, while mentoring Level 2 engineers — and I continue to develop toward Product and Offer Management.",
  ],
  overlap:
