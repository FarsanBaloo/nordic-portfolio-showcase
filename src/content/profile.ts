...
export const journeyIntro = [
  ...
  "Twenty-five years later I build AI-enabled products. The setting has changed; the question has not.",
];
...
export const journeyNarrative = {
  ...
  paragraphs: [
    ...
    "Later, I became Sweden's national technical expert for a digital building platform and its ecosystem of hardware, embedded and edge devices, and AI-enabled products. My view widened: the faults that kept coming back, the workarounds customers relied on, and the constraints facing the teams building and supporting the platform. I listened across roles, adapting my support to what each person actually needed.",
    ...
    "As Senior Technical Advisor, I worked where customer needs, technology, delivery and business value meet. I led customer and technical discovery, shaped and presented solution proposals for complex healthcare, pharmaceutical and other mission-critical environments, and weighed options against customer value, feasibility, lifecycle risk, reliability and cost. I held end-to-end technical responsibility from problem definition and requirements through solution architecture, integration, validation and delivery.",
    ...
    "In 2023, alongside my work as Senior Technical Advisor, I began formal studies in Computer Science, Intelligent Systems, applied AI and interaction design. I wanted to explore new ways to address practical and societal challenges. I completed a degree focused on applied AI and then deepened that foundation through postgraduate studies in natural language processing, machine learning and data analytics.",
    "I then studied Industrial Economics and Management to connect technology with strategy, business models and business value. Further advanced studies in product management, requirements management, value-driven design, innovation and leadership deepened my focus on user needs, product discovery and prioritisation.",
    "Across these studies, I refined a multi-agent AI decision-support concept course by course, combining my domain knowledge with what I was learning. The aim was to help people understand buildings' hidden energy problems and make informed decisions. It gave me a practical way to connect user needs, requirements, product choices and potential customer and business value.",
