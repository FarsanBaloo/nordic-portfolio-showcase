...
export const journeyNarrative = {
  ...
  paragraphs: [
    "I began as a Project Engineer, working alongside customers in plant rooms and control cabinets — understanding what they were really trying to get done, what hurt today, and what would break if we got it wrong. From requirements and system design through programming, integration and commissioning, I stood next to the customer when it went live. That is where I learned the lesson everything else builds on: a product is only as good as the day-to-day reality of the people who depend on it. Later, as Sweden's national technical expert for a digital building platform and its ecosystem of edge devices, I saw the faults that kept coming back, the workarounds customers relied on, and the constraints facing the teams building and supporting the platform — adapting my support to what each person actually needed.",
    "Working with Global Product Support, Product Owners and R&D, I turned recurring field issues into structured product feedback and justified enhancement proposals, prioritised critical defects and validated releases. I also led development of a reusable HVAC deviation-management digital product, sold through the market organisation. As Senior Technical Advisor, I led customer and technical discovery for complex healthcare, pharmaceutical and other mission-critical environments — developing and presenting solution proposals to management, sales and customer stakeholders, weighing trade-offs against customer value, feasibility, lifecycle risk and cost, and holding end-to-end technical responsibility from problem definition through delivery. I was often the informal technical lead others turned to when those trade-offs became complex.",
    "Curiosity about what AI could realistically make possible — and a drive to connect that with real societal challenges — is what brought me back to study. In 2023, during my time as Senior Technical Advisor, I began a B.Sc. in Computer Science with a specialisation in Intelligent Systems at Mälardalen University, then continued with advanced studies in natural language processing, machine learning and data analytics. I pursued a specialisation in Industrial Economics and Management at Blekinge Institute of Technology to connect that technical understanding with user needs, product strategy and viable business models — product management, requirements, value-driven design, innovation and leadership.",
    "Talking SCADA became the case where these perspectives met. SCADA systems are the control systems that monitor and steer ventilation, heating, cooling, measurements and alarms in large buildings — rich in data, but hard to interpret. Starting at the University of Skövde and refined through product, requirements, strategy and business-model coursework at BTH, the case explored letting the building explain, in plain language, where energy is being wasted, what is likely causing it and what to look at next — connecting customer and business value while keeping human judgement central.",
    "After completing my postgraduate studies, in October 2026 I stepped into the Nordic Technical Support Expert role for Building Management Systems — supporting technicians and EcoXpert partners across the Nordic region, owning major strategic customers, and overseeing Nordic defect and improvement prioritisation with R&D for EcoStruxure Building Operation and its ecosystem of edge controllers. The role brings regional customer and market insight closer to platform-quality and lifecycle decisions, while mentoring colleagues across Technical Support — and I continue to develop toward Product and Offer Management.",
  ],
  overlap:
