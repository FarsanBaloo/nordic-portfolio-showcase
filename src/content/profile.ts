...
export const journeyNarrative = {
  ...
  paragraphs: [
    ...
    "Curiosity about what AI could realistically make possible brought me back to study: a B.Sc. in Computer Science (Intelligent Systems) at Mälardalen University from 2023, then advanced studies in natural language processing, predictive data analytics, computer vision and autonomous systems.",
