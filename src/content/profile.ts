...
export const journeyNarrative = {
  ...
  paragraphs: [
    ...
    "Across these studies, I refined a multi-agent AI decision-support concept course by course, combining 20+ years of domain experience with applied AI, requirements management and product strategy. I used the concept to connect user needs, technical choices and potential customer and business value. Its aim is to help people make sense of data from interacting building systems, understand hidden energy problems and decide what to do next, with human judgement at the centre.",
