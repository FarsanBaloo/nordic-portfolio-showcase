...
export const journeyNarrative = {
  ...
  paragraphs: [
    ...
    "Curiosity about what AI could realistically make possible — and a drive to connect that with real societal challenges — is what brought me back to study. In 2023, during my time as Senior Technical Advisor, I began studies at Mälardalen University, earning a B.Sc. in Computer Science with a specialisation in Intelligent Systems and a focus on applied AI, then continued with advanced studies in natural language processing, machine learning and data analytics.",
