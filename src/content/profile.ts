export const profile = {
  ...
  email: "sorlin79@gmail.com",
  phoneDisplay: "0730 795 308",
...
export const journeyIntro = [
  "I did not start in product. I started where the customer is — in plant rooms, control cabinets and control centres — learning what people were actually trying to get done, and what it costs them when a product ignores that.",
  "More than 20 years later I build AI-enabled products. The setting has changed; the question has not.",
];
...
export const whatIBring = [
  {
    ...
    body: "A career spent close to real customers — uncovering the job to be done and the pains of both external users and internal stakeholders in engineering, QA, R&D and business.",
  },
  {
    title: "Industrial & Platform Depth",
    body: "More than 20 years in complex, real-world B2B environments — connected systems, building and energy technology, and operations where failure is visible and costly.",
  },
  {
...
export const journeyNarrative = {
  ...
  paragraphs: [
    "I began as a Project Engineer, working with customers on discovery — understanding the job to be done and what would break if we got it wrong. From requirements to delivery of digital solutions for building operation and energy optimisation, I stood next to the customer at go-live and learned the lesson everything else builds on: a product's real value is decided by the people who use it every day, not by the requirements that define it. As Sweden's national technical expert for a digital building platform and its edge controllers, I saw the faults that kept coming back. I owned a reusable capability that turned HVAC data into actionable insight, and with Product Owners and R&D turned recurring field issues into structured product feedback and enhancement proposals, prioritised critical defects and validated releases.",
    "The next step moved me closer to the business. As Senior Technical Advisor, I led discovery for healthcare, pharmaceutical, data-centre and other mission-critical customers. I presented solution proposals, weighed customer value, feasibility, lifecycle risk and cost, and held end-to-end technical responsibility — making sure what we proposed was viable to sell, build and support. I also represented Schneider Electric at KTH Live-In Lab, an open innovation platform, as its EcoStruxure Building Operation contact.",
    "Curiosity about what AI could realistically make possible brought me back to study: a B.Sc. in Computer Science (Intelligent Systems) at Mälardalen University from 2023, then advanced studies in machine learning, natural language processing, predictive data analytics, computer vision and autonomous systems.",
    "To move from technology toward product, strategy and business, I specialised in Industrial Economics and Management at Blekinge Institute of Technology. My career has always been about creating value through products and digital solutions — now I wanted to get closer to the customer and shape solutions from real problems. Product management, requirements, innovation, strategy, business models and leadership gave me the tools.",
    "Talking SCADA became the case where these perspectives met: letting a building explain in plain language where energy is wasted, why, and what to investigate next — with human judgement kept central.",
    "After my studies, I stepped into an intermediate role as Nordic Technical Support Expert — owning strategic customers, mentoring Level 2 advanced support engineers, and turning recurring Nordic field cases into structured product feedback and enhancement proposals with R&D for EcoStruxure Building Operation and its edge controllers. I continue to develop toward Product and Offer Management.",
  ],
  overlap:
  ...
  emphasis:
    "That is what I bring to product management and offer strategy: I start with the customer's problem, not the solution. I understand both sides — the people who run complex digital platforms and connected systems, and the teams who build, deliver and support them. I have hands-on experience with applied AI — RAG, forecasting, agentic systems — and know what it can realistically support and where human judgement must stay central. I align engineering, R&D, sales and support around a shared direction. I listen before defining, validate before committing, make trade-offs visible, and weigh customer value and business-model fit alongside feasibility — so a direction is not only desirable to build, but viable to offer and sustain.",
};
