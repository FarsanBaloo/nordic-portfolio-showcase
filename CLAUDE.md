...
2. If the NAS's checked-out HEAD is behind `origin/main`, deploy:
   ...
   ```
3. What `update.sh` actually does (re-read it on the NAS if this drifts — it is the source of
   truth, this is a description of it):
   ...
   - Verifies 8 routes respond: `/ /journey /projects /education /about /contact
     /projects/talking-systems /assets/rickard-portrait.png`.
...
- Release checkout + `update.sh`: `/volume1/docker/rickard-portfolio/release`
